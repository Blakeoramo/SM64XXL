...
bad news, I'm sorry\n\
to hear about it. So\n\
let's fill the players\n\
in on the scoop!\n\
Mario has been diagnosed\n\
with diabetes, so he needs\n\
to be careful not to eat\n\
too many of those\n\
chocolate coins or he'll\n\
die of morbid obesity.\n\
However, you can burn,\n\
these calories off, but\n\
it ain't no walk in the\n\
park, you'll have to work\n\
for it if you wanna lose\n\
any kind of weight.\n\
Feel free to try out the\n\
extras in the revamped\n\
pause menu, such as,\n\
LSD Mode,\n\
Widescreen Mode,\n\
and DK Mode.\n\
DK Mode gives you a big\n\
head. LSD Mode corrupts,\n\
the skybox but be warned\n\
that you may have to\n\
pause the game twice for\n\
it to work.\n\
Either that or exit\n\
from the course you're\n\
in. You can also press\n\
the L trigger to toggle\n\
the fitness meter on\n\
and off!\n\
Widescreen Mode fixes\n\
the skybox for\n\
emulators such as\n\
Project64 1.6 with an\n\
Override Aspect\n\
option.\n\
